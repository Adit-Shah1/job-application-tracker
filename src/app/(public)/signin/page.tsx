          ...
          <CardContent className="flex flex-col gap-3">
            ...
            {!noProviders && (
              <p className="mt-2 text-center text-xs text-zinc-500 dark:text-zinc-400">
                {enabledProviders.github && !enabledProviders.google && "GitHub sign-in is enabled. To enable Google, add AUTH_GOOGLE_ID and AUTH_GOOGLE_SECRET to .env."}
                {!enabledProviders.github && enabledProviders.google && "Google sign-in is enabled. To enable GitHub, add AUTH_GITHUB_ID and AUTH_GITHUB_SECRET to .env."}
              </p>
            )}
          </CardContent>
        </Card>
